  ...
  <div class="content-wrapper" style="min-height: 976px;">
    ...
    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
	  ...
	  <table id="current" class="display" cellspacing="0" width="100%">
        ...
        <tbody>
            <tr>
                <td>${yrec.year}</td>
                <td>${yrec.status}</td>
                <td><a href="Appraisal.ds?value=${yrec.goalYearId}">Edit</a></td>
            </tr>
        </tbody>
    </table>            </div>
            </div>
	  ...
	  <table id="history" class="display" cellspacing="0" width="100%">
        ...
        <tbody>
           <c:forEach var="record" items="${recs}">   
                 <tr>
                <td>${record.year}</td>
                <td>${record.status}</td>
                <td><a href="Appraisal.ds?value=${record.goalYearId}">Edit</a></td>
            </tr>
   </c:forEach> 
        </tbody>
    </table>                 </div>
    ...
    <div class="panel panel-default">
	  ...
	  <table id="tobeapproved" class="display" cellspacing="0" width="100%">
        ...
        <tbody>
         <c:forEach var="records" items="${zrecs}"> 
         <tr>
                 <td>${records.employeeName}</td>
                <td>${records.status}</td>
                <td>${records.DOJ} </td>
               <td><a href="Appraisal.ds?value=${records.goalYearid}">Edit</a></td> 
                </tr>
           </c:forEach>
        </tbody>
    </table>            </div>
	...
	<div class="panel panel-default">
	  ...
	  <table id="tobeevaluated" class="display" cellspacing="0" width="100%">
        ...
        <tbody>
         <c:forEach var="recordss" items="${zrecss}"> 
         <tr>
                 <td>${recordss.employeeName}</td>
                <td>${recordss.status}</td>
                <td>${recordss.DOJ} </td>
               <td><a href="Appraisal.ds?value=${recordss.goalYearid}">Edit</a></td> 
                </tr>
           </c:forEach>
